...
case ${target} in 
   cuda10)  
      ...
      pip install mmcv-full==1.3.17 -f https://download.openmmlab.com/mmcv/dist/cu102/torch1.11.0/index.html --upgrade -q    
      ;; 
   ...
   cuda11)  
      ...
      echo "- Installing mmcv"
      pip install mmcv-full==1.3.17 -f https://download.openmmlab.com/mmcv/dist/cu111/torch1.11.0/index.html --upgrade -q  
    ;;  
   ...
   cpu)  
      ...
      echo "- Installing mmcv"
      pip install mmcv-full=="1.3.17" -f https://download.openmmlab.com/mmcv/dist/cpu/torch1.11.0/index.html --upgrade -q  
    ;;
